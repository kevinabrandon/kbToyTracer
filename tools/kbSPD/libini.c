...
".wrl", /* OUTPUT_VRML1      Virtual Reality Modeling Language 1.0       */
".wrl", /* OUTPUT_VRML2      Virtual Reality Modeling Language 2.0       */
".sdf", /* OUTPUT_SDF        kbToyTracer Scene Description File          */
...
#endif
{
	...
	else if (gRT_out_format == OUTPUT_SDF && gSDF_scene_open) {
		if (gSDF_group_open) {
...
void show_gen_usage PARAMS((void))
{
    ...
    fprintf(stderr, "   20  kbToyTracer SDF scene (default)\n");
